...
const Programs = () => {
  return (
    ...
    <p>Denizden Gelen Lezzetlerin En Güzel Adresi!</p>

    <p>Ege’nin masmavi sularının kenarında yer alan Seaside Savories,
         size deniz ürünlerinin en tazesini ve en lezizini sunmak için burada.
